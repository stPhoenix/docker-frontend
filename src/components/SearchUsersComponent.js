...
export const SearchUsersComponent = (props) => {
    return (
        <section className="d-flex flex-column">
            <br />
            <h3>Search Users list</h3>
            <Form>
                <Form.Group controlId="formBasicUsername">
                    <Form.Label>Username</Form.Label>
                    <Form.Control type="text" placeholder="Enter username" name="userName" value={props.userName} onChange={props.handleChange} />
                </Form.Group>
                <Button variant="primary" type="submit" onClick={props.searchUsers}>
                    Submit
                </Button>
            </Form>
            <br/>
